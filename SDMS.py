...
def run_query(query,parameters=()):
    conn = psycopg2.connect(dbname="studentdb", user="", password="",host="localhost",port="5432")
    cur = conn.cursor()
    query_result = None
    try: 
...
tree_frame.grid(row=2,column=0,padx=10,pady=2,sticky="nsew")

# Add scrollbar to right of treeview
...
# Add labeled columns to treeview
tree['columns']=("student_id","name","address","age","number")

# Make first column invisible as we have no heirachy
